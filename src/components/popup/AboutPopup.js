        ...
        <div className="left">
          <div className="left_inner">
            ...
            <div className="edrea_tm_button full">
              <a href="img/about/cv.pdf" download>
                Download CV
              </a>
            </div>
          </div>
        ...
        <div className="right">
          <div className="right_inner">
            <div className="biography">
              ...
              <div className="text">
                <p>
                  Hello everybody! My name is <span>Osama Mohamed.</span> Freelance MERN stack specialist, skilled in web design and development. Expertise includes MongoDB, Express.js, React, Node.js, with a focus on SEO, page speed, and versatile tech proficiency for tailored solutions.
                </p>
              </div>
            </div>
            ...
            <div className="timeline">
              <div className="about_title">
                <h3>
                  <span>
                    Experience <span className="coloring">Timeline</span>
                  </span>
                </h3>
              </div>
              <div className="list">
