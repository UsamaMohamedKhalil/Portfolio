...
import PortfolioModalTwo from "./popup/PortfolioModalTwo";
...
const Portfolio = () => {
  ...
  return (
    <Fragment>
      ...
      <PortfolioModalTwo open={modalTwo} close={() => setModalTwo(false)} />
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="list_inner">
                      <div className="image">
                        ...
                        <div
                          className="main"
                          data-img-url="img/portfolio/888.png"
                        />
                      </div>
                      <div className="details">
                        <h3>Elmorshedy Store</h3>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="list_inner">
                      <div className="image">
                        ...
                        <div
                          className="main"
                          data-img-url="img/portfolio/88.png"
                        />
                      </div>
                      <div className="details">
